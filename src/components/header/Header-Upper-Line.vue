  ...
  <div class="upper-line">
    <div class="container">
      <div class="upper-line__content">
        <div class="d-flex">
          <div class="dropdown">
            <button class="dropdown-toggle" type="button" id="cityDropdown" data-bs-toggle="dropdown"
                    aria-expanded="false">
              Ташкент
            </button>
            ...
            <template #items>
              <input-radio name="language">
                <div class="d-flex align-items-center mt-1">
                  <russian></russian>
                  <span style="align-self: center; display:inline-block;"
                        class="pl-3 pt text-sm text-center">Русский</span>
                </div>
              </input-radio>
              <input-radio name="language">
              <div class="d-flex align-items-center mt-1">
                <uzbek></uzbek>
                <span style="align-self: center; display:inline-block;"
                      class="pl-3 pt text-sm text-center">O’zbekcha</span>
              </div>
              </input-radio>
              <input-radio name="language">
                <div class="d-flex align-items-center h-100 mt-1">
                  <english></english>
                  <span style="align-self: center; display:inline-block;"
                        class="pl-3 pt text-sm text-center">English</span>
                </div>
              </input-radio>
            </template>
          </dropdown>
...
export default {
  ...
  components: {English, Uzbek, Dropdown, Russian, InputRadio},
  data() {
    return {}
  },
}
